...
window.MaxExtensionFloatingPanel.togglePanel = async function (event) {
    ...
    try {
        ...
        if (this.isPanelVisible) {
            ...
            // Queue runtime state is shared by the floating and inline views.
            // Closing one view must not stop its timer or discard its items.
