...
window.OneClickPromptsContainerHeuristics = {
    ...
    findAlternativeContainer: async function (failedSelectors) {
        ...
        // Do not inject into <body> merely to avoid returning null. Body placement can disrupt
        // site layout and makes the configured Floating Panel fallback unreachable.
        logConCgp('[ContainerHeuristics] No safe alternative container found after exhaustive search.');
        return null;
    },
